...
export const Titlebar = () => {
  ...
  return (
    ...
    >
      <div
        data-tauri-drag-region
        className="left w-1/3 p-1 ml-2 flex items-center"
        style={plutoState?.Theme.getClassName("titlebar.logo")}
      >
        <img src={Logo} alt="Pluto" className="h-full p-1 mt-1" />
        <TitlebarDropdown
          title="File"
          config={{ "file.new": "New File", "file.new-window": "New Window" }}
        />
      ...
      <div
        data-tauri-drag-region
        className="middle w-1/3 flex items-center justify-center"
      >
        <img src={LogoText} alt="Pluto" className="h-full" />
      </div>
      <div
        className="right w-1/3 flex items-center justify-end"
        data-tauri-drag-region
      >
        <p
